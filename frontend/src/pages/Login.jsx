  ...
  return (
    ...
    >
      <div className="inline-flex items-center gap-2 mb-2 mt-10">
        ...
        <hr className="border-none h-[2px] w-10 bg-gray-900 rounded" />
      </div>
      ...
      <button className="bg-black text-white font-semibold px-8 py-2 mt-4 rounded-lg hover:bg-gray-800 transition">
